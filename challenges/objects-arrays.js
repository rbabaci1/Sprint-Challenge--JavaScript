...
tyrannosaurus.road = function() {
  return 'RAWERSRARARWERSARARARRRR';
}
console.log(tyrannosaurus.road());
...
graduates.forEach(student => {
  if (student.university.match(/Uni/g) !== null) {
    unisWithUni.push( {university: student.university} );
  }
})
...
*/
const populationTotal = zooAnimals.reduce((accumulator, currentAnimal) => accumulator + currentAnimal.population, 0);
